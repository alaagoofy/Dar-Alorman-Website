<%@ Page Title="بث مباشر من البرازيل" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Brazil.aspx.cs" Inherits="Gallery_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" Runat="Server">
    ...
    <section class="top-page-nav">
        <div class="center cf">
            ...
            <h2>بث مباشر من البرازيل</h2>

            <div class="navi">
               
                <a href="/home">الرئيسية</a>
                <span></span>
                <a  class="active" href="/Online/Brazil.aspx">بث مباشر من البرازيل </a>
       ...
       <div class="center cf">
        ...
        <section class="col-8 blog cf">
           ...
           <div class="gallery">
                ...
                <div class="menu cf">
                    <a class="active" href="#">بث مباشر من البرازيل</a>
                ...
                <div class="photos cf">
                    ...
                    <iframe src="http://new.livestream.com/accounts/10175353/events/3452112/player?width=560&height=315&autoPlay=true&mute=false" width="660" height="415" frameborder="0" scrolling="no"> </iframe>

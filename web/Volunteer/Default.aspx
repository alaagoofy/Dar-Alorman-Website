<%@ Page Title="إستمارة تطوع" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Complain_Default" %>
    ...
    <section class="top-page-nav">
        <div class="center cf">
            ...
            <div class="navi">
                ...
                <span></span>
                <a  class="active" href="/Volunteer">إستمارة تطوع </a>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <section class="col-8 blog cf">
            ...
            <div class="gallery">
                ...
                <div class="menu cf">
                    <a class="active" href="#">إستمارة تطوع</a>
      ...
      <div class="form">
          ...
          <br /><br />
            <div class="clr"></div>
            <asp:TextBox ID="txt_address" style="width:95%" runat="server" placeholder="العنوان">
          ...
          <br /><br />
            ...
            <div class="clr"></div>
            <asp:TextBox ID="txt_education" style="width:95%" runat="server" placeholder="المؤهل الدراسى">

            </asp:TextBox>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_education" 
                             CssClass="failureNotification" ErrorMessage="*" ToolTip="*" 
                             ValidationGroup="a">*</asp:RequiredFieldValidator>
          <br /><br />
            ...
            <div class="clr"></div>
            <asp:TextBox ID="txt_job" style="width:95%" runat="server" placeholder="الوظيفة الحالية">

            </asp:TextBox>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_job" 
                             CssClass="failureNotification" ErrorMessage="*" ToolTip="*" 
                             ValidationGroup="a">*</asp:RequiredFieldValidator>
          <br /><br />
            ...
            <div class="clr"></div>
            <asp:TextBox ID="txt_national" style="width:95%" runat="server" placeholder="الجنسية">

            </asp:TextBox>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_mail" 
                             CssClass="failureNotification" ErrorMessage="*" ToolTip="*" 
                             ValidationGroup="a">*</asp:RequiredFieldValidator>
          <br /><br />
            ...
            <div class="clr"></div>
            <asp:TextBox ID="txt_answer" style="width:95%" runat="server" placeholder="هل شاركت فى العمل التطوعى من قبل">

            </asp:TextBox>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txt_answer" 
                             CssClass="failureNotification" ErrorMessage="*" ToolTip="*" 
                             ValidationGroup="a">*</asp:RequiredFieldValidator>
          <br /><br />
          ...
          <div class="clr"></div>
           <asp:TextBox ID="txt_body" style="width:95%" runat="server" TextMode="MultiLine" placeholder="ملاحظات خاصة بك"></asp:TextBox>

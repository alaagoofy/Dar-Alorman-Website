...
<!-- only display these next fields if not an error -->
    ...
    <tr class="shade" style="display:none">
        <td align="right"><strong><em>Security Settings : </em></strong></td>
        <td>
          <span style="color:#27e003;font-size:17px"> <asp:Literal ID="Literal2" runat="server"></asp:Literal></span> 
        <span style="color:#f00;font-size:17px"> <asp:Literal ID="Literal3" runat="server"></asp:Literal></span> 
             </td>
    </tr>
</asp:Panel>
    <tr>

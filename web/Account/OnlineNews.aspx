<%@ Page Title="أخبار أون لاين" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OnlineNews.aspx.cs" Inherits="Account_News" %>
           ...
           <asp:TextBox ID="txt_Title" placeholder=" العنوان" style="width:98%" runat="server"></asp:TextBox>
                   <br /> <br /> 
                    ...
                    <br /> <br /> 
                     ...
                     <asp:TextBox ID="txt_Url" placeholder="أدخل لينك الخبر" runat="server"></asp:TextBox>
                    <br /> <br /> 

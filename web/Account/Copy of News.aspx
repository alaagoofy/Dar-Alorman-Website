<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Copy of News.aspx.cs" Inherits="Account_News" %>
    ...
    <section class="top-page-nav">
        <div class="center cf">
            ...
            <div class="navi">
                ...
                <span></span>
                <a  class="active" href="/News">أخبارنا </a>
       ...
       <div class="center cf">
        ...
        <section class="col-8 blog cf">
           <div class="gallery">
                ...
                <div class="menu cf">
                    <a class="active" href="#">أدخل الخبر</a>
           ...
           <asp:TextBox ID="txt_Title" placeholder=" العنوان" style="width:98%" runat="server"></asp:TextBox>
                   <br /> <br /> 
                    <strong>إختر صورة الخبر</strong>
                      <asp:FileUpload ID="upload_Img"  runat="server" />
                    <asp:Image ID="image_Img" Width="307px"  runat="server" />
                    <br /> <br /> 
                    <strong>إختر شعار الجريدة</strong>
                      <asp:FileUpload ID="upload_Thumb"  runat="server" />  
                    <asp:Image ID="image_thumb" Width="90px"  runat="server" />
                    <br /> <br /> 
                     <asp:TextBox ID="txt_Date" placeholder="التاريخ" style="width:98%" runat="server"></asp:TextBox>
        ...
        <aside class="col-4 blog cf">
             ...
             <div class="menu cf" style="margin:2px 0 0 0">
                  ...
                  <div class="menu cf" style="margin:2px 0 0 0">
                    <div class="active"><a href="#"> ألبومات الصور</a></div>

                 
                </div>

                  <div class="menu cf" style="margin:2px 0 0 0">
                    <div class="active"><a href="#">  الصور</a></div>

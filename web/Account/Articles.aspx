<%@ Page Title="تعديل وإضافة المقالات" Language="C#" ValidateRequest="false" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Articles.aspx.cs" Inherits="Account_News" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script type="text/javascript">
        var menuGroup = 'm5'
</script>
    <script src="/Account/ckeditor/ckeditor.js"></script>
    <style>
        .menu a {
            color: #fff;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="Server">
    ...
    <section class="top-page-nav">
        <div class="center cf">
            ...
            <h2>تعديل وإضافة المقالات</h2>

            <div class="navi">

                <a href="/home">الرئيسية</a>
                <span></span>
                <a class="active" href="/News">تعديل وإضافة المقالات </a>
    ...
    <div class="center cf">
        ...
        <section class="col-8 blog cf">
            <div class="gallery">
                ...
                <div class="menu cf">
                    <a class="active" href="#">المقالات</a>
                ...
                <div class="form">
                    ...
                    <asp:TextBox ID="txt_Title" placeholder=" عنوان المقال" Style="width: 98%" runat="server"></asp:TextBox>
                    <br />
                    <br />
                    <strong>أدخل المقال</strong>
                    <br />

...
<section class="news" style="margin:0;padding:0;background-size:98% 600px;background-position:top center">
	    ...
	    <img src="AAIB logo.gif" style="width:100%;margin:0 auto 20px;display:block" alt="" />
		<img src="aaib.jpg" style="width:100%;margin:0 auto 20px;display:block" alt="" />
...
<input type="hidden" name="Title" value="ASP.NET C# VPC 3-Party"/>
     ...
     <p style="display:none">
      ...
      <p style="display:none">
       <input type="text" name="vpc_AccessCode" value="090AF86A" size="20" maxlength="8"/>
   </p>
    <p style="display:none">
      <asp:TextBox ID="vpc_MerchTxnRef"   runat="server"></asp:TextBox>
      </p>
      <p style="display:none">
       <input type="text" id="vpc_Merchant" name="vpc_Merchant" value="701342USD" size="20" maxlength="16"/>
   </p>
       <p style="display:none">
      ...
      <p style="display:none">
      <input type="text" name="vpc_ReturnURL" size="63" value="http://dar-alorman.com/aaibUSD/CS_VPC_3Party_DR.aspx" maxlength="250"/>
   </p>
      <p style="display:none">

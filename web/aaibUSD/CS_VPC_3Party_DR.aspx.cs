...
public partial class CS_VPC_3Party_DR : System.Web.UI.Page
{
   ...
   */
        ...
        string SECURE_SECRET = "E0CC752FFD8E920ADEEC84861A3276B9";
...
# endif
            ...
            Label_Amount.Text = realAmount.ToString() + " USD";
            ...
            if (!errorExists && !txnResponseCode.Equals("7"))
            {
                ...
                obj.MerchState = "";
                obj.Project = Page.Request.QueryString["Project"].ToString();
                ...
                try
                {
                    ...
                    string htmlBody;
                    htmlBody = "<html><body><p> MerchTxnRef:  " + Label_MerchTxnRef.Text + "</p><p>Transaction Amount : " + realAmount + " USD " + "</p><p>Transaction response:  : <font color='#00AA00'><b>successfully</b></font></p></body></html>";
                    mail.Body = htmlBody;
                    SmtpServer.Port = 587;
            ...
            else
            {
                ...
                try
                {
                    ...
                    mail.IsBodyHtml = true;
                    string htmlBody;
                    htmlBody = "<html><body><p>Order Info:  " + Label_OrderInfo.Text + "</p><p>Transaction Amount : " + realAmount + " USD " + "</p><p>Transaction response  : <font color='#FF0066'><b>INVALID </b></font></p></body></html>";
                    mail.Body = htmlBody;
                    SmtpServer.Port = 587;
                    SmtpServer.UseDefaultCredentials = false;

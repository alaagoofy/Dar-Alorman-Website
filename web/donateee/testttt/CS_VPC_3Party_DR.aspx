...
<style type='text/css'>
    ...
    .title   { height:25px; background-color:#77A94C }
    ...
    div.bl   { font-family:Verdana,Arial,sans-serif; font-size:7pt;  color:#77A94C }
...
<!-- only display these next fields if not an error -->
    ...
    <tr class="shade" style="display:none">
        <td align="right"><strong><em>Transaction response : </em></strong></td>
<td><asp:Label id="lbl_error" runat="server"/></td>
        <td style="display:none"><asp:Label id=Label_ReceiptNo runat="server"/></td>
    </tr>
    <tr style="display:none">

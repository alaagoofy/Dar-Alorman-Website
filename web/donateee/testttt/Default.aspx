...
<section class="news" style="margin:0;padding:0;background-size:98% 600px;background-position:top center">
		...
		<img src="/css/images/donate1.png" style="width:884px;margin:0 auto 20px;display:block" alt="" />
                	...
                	<img src="/aaibUSD/aaib.jpg" style="width:884px;margin:0 auto 20px;display:block" alt="" />
...
<input type="hidden" name="Title" value="ASP.NET C# VPC 3-Party"/>
    ...
    <p style="display:none">
      ...
      <p style="display:none">
      <input type="text" name="vpc_ReturnURL" size="63" value="http://www.dar-alorman.com/donate/CS_VPC_3Party_DR.aspx" maxlength="250"/>
   </p>
      <p style="display:none">

...
# endif
            ...
            else
            {
                ...
                try
                {
                    ...
                    mail.IsBodyHtml = true;
                    string htmlBody;
                    htmlBody = "<html><body><p>Order Info:  " + Label_OrderInfo.Text + "</p><p>Transaction Amount : " + realAmount + " LE " + "</p><p>Transaction response  : <font color='#FF0066'><b>INVALID </b></font></p></body></html>";
                    mail.Body = htmlBody;
                    SmtpServer.Port = 587;
                    SmtpServer.UseDefaultCredentials = false;

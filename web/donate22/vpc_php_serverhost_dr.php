...
include('../dar2/include/config.php');
...
{
    $myresult = "<div style='color:green';>ÊãÊ ÚãáíÉ ÇáÊÈÑÚ ÈäÌÇÍ.. ÔßÑÇ áß</div>";
...
<table background="http://dar-alorman.com/donate/rec.jpg" width="500px" height="417px" border="0" cellpadding="0" cellspacing="0">
...
<tr><td align="right" width="210"><font color="#0b350f"><b> ÊÊæÌå ÌãÚíÉ ÇáÇæÑãÇä ÈÇáÔßÑ ááÓíÏ : </b></font></td><td align="right" height="22">'.$donator_name.'</td></tr>
<tr><td align="right"><font color="#0b350f"><b>áÊÈÑÚÉ ÈãÈáÛ æ ŞÏÑÉ :  </b></font></td><td align="right" height="27">'.($amount/100).' EGP </td></tr>
<tr><td align="right"><font color="#0b350f"><b>ÇáÑŞã ÇáãÑÌÚì :  </b></font></td><td align="right" height="27">'. $receiptNo .'</td></tr>
<tr><td align="right"><font color="#0b350f"><b>ÑŞã ÇáÊáíİæä :  </b></font></td><td align="right" height="28">'. $donator_phone .'</td></tr>
<tr><td align="right"><font color="#0b350f"><b>ÈÊÇÑíÎ :  </b></font></td><td align="right" height="28">'.$today['mday'].'/'.$today['mon'].'/'.$today['year'] .'</td></tr>
...
<tr><td height="137"></td></tr>
     ...
     mymailer("orman society","admin@dar-alorman.com",$donator_mail,"ÊÇßíÏ ÚãáíÉ ÇáÊÈÑÚ",$message_post);
     //mymailer("orman society","admin@dar-alorman.com","eng.shenawy@live.com","ÊÇßíÏ ÚãáíÉ ÇáÊÈÑÚ",$message_post);
     
       
if(!empty($donator_addr))
{
...
<table border="1" width="100%" align="center" style="text-align: right; direction: rtl; font-family: arial; font-size: 11pt; font-weight: bold;">
            <tr class="title">
                <td colspan="2" height="25" style="background-color: #f2f2f2; color:red;"><P><strong>æÕæá åĞå ÇáÑÓÇáÉ åäÇ ÊÚäì Çä ÕÇÍÈ ÚãáíÉ ÇáÊÈÑÚ íÑíÏ ÇÑÓÇá ÇáÇíÕÇá Úáì ÚäæÇäå</strong></P></td>
            </tr>            
            
            <tr class="title">
                <td colspan="2" height="25" style="background-color: #f2f2f2;"><P><strong>ÈíÇäÇÊ ÚãáíÉ ÇáÏİÚ</strong></P></td>
            </tr>

            <tr>
                <td align="right"><strong>ÑŞã ÊÚÑíİ ÚãáíÉ ÇáÊÈÑÚ : </strong></td>
                <td>'.$merchTxnRef.'</td>
            </tr>

            <tr class="shade">
                <td align="right"><strong>ãŞÏÇÑ ÇáÏİÚ : </strong></td>
                <td>'.($amount/100).' ÌäíÉ ãÕÑì</td>
            </tr>

            <tr>
                <td align="right"><strong>äÊíÌÉ ÚãáíÉ ÇáÊÈÑÚ : </strong></td>
                <td>'. $myresult .'</td>
            </tr>
            <tr class="shade">
                <td align="right"><strong>ÇáÑÓÇáÉ ãä ÇáÎÇÏã : </strong></td>
                <td>'.$message.'</td>
            </tr>

            <tr>
                <td align="right"><strong>ÑŞã ÇáÇíÕÇá : </strong></td>
                <td>'.$receiptNo.'</td>
            </tr>
            <tr class="shade">
                <td align="right"><strong>ÑŞã ÚãáíÉ ÇáÊÈÑÚ : </strong></td>
                <td>'.$transactionNo.'</td>
            </tr>            
            
            <tr class="shade">
                <td align="right"><strong>ÇáÚäæÇä : </strong></td>
                <td>'.$donator_addr.'</td>
            </tr>
...
ÇÏÇÑÉ ãæŞÚ ÌãÚíÉ ÇáÇæÑãÇä
     ...
     mymailer("orman society","admin@dar-alorman.com","donation@dar-alorman.com","ÚãáíÉ ÊÈÑÚ",$message_post);
...
{
    $myresult = "<div style='color:red';>ÎØÇ ÑŞã : ".$acqResponseCode . "</div>";
}
...
<html>
    <head>
        <title>äÊíÌÉ ÚãáíÉ ÇáÊÈÑÚ</title>
    ...
    <body>
        ...
        <table width="85%" align="center" cellpadding="5" border="0" style="direction: rtl;">
            <tr class="title">
                <td colspan="2" height="25"><P><strong>ÈíÇäÇÊ ÚãáíÉ ÇáÏİÚ</strong></P></td>
            </tr>

            <tr>
                <td align="right"><strong><i>ÑŞã ÊÚÑíİ ÚãáíÉ ÇáÊÈÑÚ.. ÇÍÊİÙ ÈÇáÑŞã: </strong></td>
                <td><?=$merchTxnRef?></td>
            </tr>
...
<? 
            ...
            <tr>
                <td align="center" colspan="2"><a href="index.php"><strong> ÇÖÛØ åäÇ ááÚæÏÉ áÕİÍÉ ÇáÊÈÑÚ ÇáÑÆíÓíÉ </strong></a></td>
            </tr>
...
function getResponseDescription($responseCode) {
    ...
    switch ($responseCode) {
        case "0" : $result = "ÊãÊ ÚãáíÉ ÇáÊÈÑÚ ÈäÌÇÍ.. ÔßÑÇ áß"; break;
        case "?" : $result = "ÇáäÊíÌÉ ÛíÑ ãÚÑæİÉ"; break;
        case "1" : $result = "ÎØÇ ÛíÑ ãÚÑæİ"; break;
        case "2" : $result = "Êã ÑİÖ ÚãáíÉ ÇáÊÈÑÚ"; break;
        case "3" : $result = "áÇ íæÌÏ ÇÓÊÌÇÈÉ ãä ÇáÎÇÏã"; break;
        case "4" : $result = "ÇáÈÇØŞÉ ÇáãÓÊÎÏãÉ ãäÊåíÉ ÇáÕáÇÍíÉ"; break;
        case "5" : $result = "áÇ íæÌÏ ÑÕíÏ ßÇİì áÚãáíÉ ÇáÊÈÑÚ"; break;
        case "6" : $result = "ÎØÇ İì ÇáÇÊÕÇá ãÚ ÎÇÏã ÇáÈäß"; break;
        case "7" : $result = "ÎØÇ İì ÇáÎÇÏã"; break;
        case "8" : $result = "äæÚ ÚãáíÉ ÇáÏİÚ ÛíÑ ãŞÈæáÉ"; break;
        case "9" : $result = "Êã ÑİÖ ÚãáíÉ ÇáÊÈÑÚ"; break;
        case "A" : $result = "Êã ÇÛáÇŞ ÇáÇÊÕÇá ÈÇáÎÇÏã"; break;
        case "C" : $result = "Êã ÇáÛÇÁ ÚãáíÉ ÇáÊÈÑÚ"; break;
        case "D" : $result = "ÚãáíÉ ÇáÊÈÑÚ ÊÍÊ ÇáİÍÕ"; break;
        case "F" : $result = "3D Secure Authentication failed"; break;
        case "I" : $result = "ÎØÇ İì ÇáÑŞã ÇáÓÑì ÇáËáÇËì"; break;
        case "L" : $result = "ÇáÊÈÑÚ ãÛáŞ ÍÇáíÇ"; break;

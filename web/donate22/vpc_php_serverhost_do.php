...
if (strlen($SECURE_SECRET) > 0) {
 ...
 $q="INSERT INTO donation (unid, amount, cur, done, purp, bank,d_time,dmail,addr,ipaddr,name,phone) VALUES ('".$_POST['vpc_MerchTxnRef']."', '".$_POST['vpc_Amount_temp']."', '".$_POST['curr']."', '0', '".$_POST['purp']."', 'bm', '".time()."', '".$_POST['dmail']."', '".$_POST['addr']."', '".$_SERVER['REMOTE_ADDR']."', '".$_POST['name']."', '".$_POST['phone']."')";
$do=mysql_query($q);

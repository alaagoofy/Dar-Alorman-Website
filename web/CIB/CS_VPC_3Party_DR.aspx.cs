...
public partial class CS_VPC_3Party_DR : System.Web.UI.Page
{
   ...
   */
        ...
        string SECURE_SECRET = "1566BEC2B82B7ADE28F869DACD9E03AE";
...
# endif
            ...
            if (!errorExists && !txnResponseCode.Equals("7"))
            {
                ...
                try
                {
                    ...
                    string htmlBody;
                    htmlBody = "<html><body><p> MerchTxnRef:  " + Label_MerchTxnRef.Text + "</p><p>Transaction Amount : " + realAmount + "</p><p>Transaction response:  : <font color='#00AA00'><b>successfully</b></font></p></body></html>";
                    mail.Body = htmlBody;
                    SmtpServer.Port = 587;

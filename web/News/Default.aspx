<%@ Page Title="أخبارنا" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="News_Default" %>
...
<section class="news" style="margin:0;padding:0;background-size:98% 600px;background-position:top center">
        <aside class="col-4 blog cf" style="width:100%;float:none;display:block">
             ...
             <div class="menu cf" style="margin:2px 0 0 0">
                    <div class="active" data-attr="m1"> الأخبار</div>
          ...
          <asp:Repeater ID="Repeater1" runat="server">
              <ItemTemplate>
                   <div class="item cf">
                    ...
                    <div class="col-9">
                        <a class="title fancybox" href='<%#Eval("Img") %>' runat="server" data-fancybox-group="gallery"><%#Eval("Title") %></a>
                        <div class="info">

...
<input type="hidden" name="Title" value="ASP.NET C# VPC 3-Party"/>
     ...
     <p style="display:none">
      ...
      <p style="display:none">
       <input type="text" name="vpc_AccessCode" value="061AC315" size="20" maxlength="8"/>
   </p>
    <p style="display:none">
      <asp:TextBox ID="vpc_MerchTxnRef"   runat="server"></asp:TextBox>
      </p>
      <p style="display:none">
       <input type="text" id="vpc_Merchant" name="vpc_Merchant" value="701342" size="20" maxlength="16"/>
   </p>
       <p style="display:none">
      ...
      <p style="display:none">
      <input type="text" name="vpc_ReturnURL" size="63" value="http://dar-alorman.com/aaibLE/CS_VPC_3Party_DR.aspx" maxlength="250"/>
   </p>
      <p style="display:none">
   ...
   المبلغ المراد التبرع به   : 
       ...
       <input type="text" name="vpc_Amount_temp" id="amount" value="1" size="20" maxlength="10" style="width: 20%;height:40px;-webkit-border-radius:5px;-moz-border-radius:5px;border-radius:5px;"> 
        ...
        <option value="egp" selected="selected">جنية مصرى</option>
    ...
    <br/><br/>
       <p>
           <select id="Select1" style="width: 100%;height:40px;-webkit-border-radius:5px;-moz-border-radius:5px;border-radius:5px;">
<option value="shefaa">مستشفى شفاء الأورمان</option>
      ...
      <p>
          من فضلك اجب على إجابة السؤال التالى 2+7 = 
...
<%--            <p>
      ...
      --%>
       ...
       <input type="submit" name="SubButL" style="padding:5px 20px;background:#F39200;
			...
			;color:#fff;margin-bottom:30px;-moz-border-radius:5px;border-radius:5px;" onserverclick="btnBeforeOk_ServerClick"   onclick="ra(); getdata(); return validate_all(); " value="تأكيد التبرع"/>
    	<br/><br/>
        <div style="clear:both"></div>

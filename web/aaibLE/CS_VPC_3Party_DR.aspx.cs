...
public partial class CS_VPC_3Party_DR : System.Web.UI.Page
{
   ...
   */
        ...
        string SECURE_SECRET = "41D15E2F6F0709B5BA99A08AAD69CAED";
...
# endif
            ...
            Label_Amount.Text = realAmount.ToString() + " LE";
            ...
            if (!errorExists && !txnResponseCode.Equals("7"))
            {
                ...
                Donorle obj = new Donorle();
                obj.Amount = realAmount;
                obj.IsApproved = true;
                obj.MerchAddress = Page.Request.QueryString["vpc_AVS_Street01"].Length > 0 ? Page.Request.QueryString["vpc_AVS_Street01"] : "";
                obj.MerchCountry = Page.Request.QueryString["vpc_AVS_Country"].Length > 0 ? Page.Request.QueryString["vpc_AVS_Country"] : "";
                ...
                try
                {
                    ...
                    string htmlBody;
                    htmlBody = "<html><body><p> MerchTxnRef:  " + Label_MerchTxnRef.Text + "</p><p>Transaction Amount : " + realAmount + " LE " + "</p><p>Transaction response:  : <font color='#00AA00'><b>successfully</b></font></p></body></html>";
                    mail.Body = htmlBody;
                    SmtpServer.Port = 587;

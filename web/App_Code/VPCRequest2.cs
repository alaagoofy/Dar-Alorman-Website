...
namespace _TNS
{
    public class VPCRequest2
    {
        ...
        public VPCRequest2()
        {
            ...
            _merchantID = appSettings["vpc_Merchant2"];
            _accessCode = appSettings["vpc_AccessCode2"];
            _vpcCommand = appSettings["vpc_Command"];
            _vpcVersion = appSettings["vpc_Version"];
            _returnURL = appSettings["vpc_ReturnURL2"];
            
            _secureSecret = appSettings["SecureSecret2"];
        }
